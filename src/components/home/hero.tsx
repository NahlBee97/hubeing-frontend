    ...
    <div className="flex flex-col items-center gap-6 md:gap-8 lg:flex-1 lg:justify-center">
      <div className="flex flex-col items-center text-center gap-2 md:text-left md:items-start">
        ...
        <h2 className="text-sm font-normal leading-normal text-white md:text-base">
          ...
          sint earum laboriosam eos recusandae dolore cumque distinctio nisi
          voluptas adipisci nemo porro blanditiis tempora deserunt sequi eveniet
          optio. Exercitationem beatae commodi, nisi, fugit reprehenderit sint
          qui illum itaque sed voluptatibus obcaecati quisquam minus sequi porro
          maxime cum voluptatem ea.
        </h2>
      </div>
      <button className="flex h-10 min-w-[84px] max-w-[480px] cursor-pointer items-center justify-center overflow-hidden rounded-lg bg-[#13ec5b] px-4 text-sm font-bold leading-normal tracking-[0.015em] text-[#112217] md:h-12 md:px-5 md:text-base lg:self-start hover:bg-[#13ec5b]/90 transition-colors">
